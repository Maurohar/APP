...
database.addBook(new Book(libro1.id, libro1.author,libro1.title,libro1.pages,libro.catalog,libro1.year,libro1.imagen));
...
let libro = bookshelf //we define the variable
    ...
    let newDivBook = document.createElement("div")
                        ...
                        newDivBook.innerHTML += `<hrs><div class="container">
                        <div class="row align-items-start">
                        <div class="col">
